          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center gap-1">
                <span className="text-3xl sm:text-4xl drop-shadow-2xl opacity-70">🌙</span>
                <span className="text-4xl sm:text-5xl drop-shadow-2xl">⭐</span>
                <span className="text-3xl sm:text-4xl drop-shadow-2xl opacity-70">🌙</span>
              </div>
            </motion.div>
                ...
                {positions.map((pos, i) => {
                  ...
                  return card ? (
                    ...
                    >
                      ...
                      <span className="text-xs">{pos.nameEs}</span>
                    </div>
                  );
                })}
              </div>
              ...
              {selectedCards.map((rc, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <motion.span
                      className="text-xs font-semibold text-secondary mt-2 tracking-wide"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
            ...
            >
              ...
              >
                ...
                <p className="text-xs text-white/40 mt-1">
                  Las tres cartas revelan tu camino
                </p>
              </motion.div>
