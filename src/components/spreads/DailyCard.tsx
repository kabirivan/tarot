  ...
  return (
    <div className="min-h-[calc(100dvh-3.5rem)] flex flex-col overflow-x-hidden relative">
      <AnimatePresence mode="wait">
        ...
        {phase === "picking" && selectedCards.length === 1 && (
          <motion.div
            key="analyzing"
            ...
            >
              ...
              <div className="space-y-2">
                <p className="font-display text-lg sm:text-xl font-light italic text-white/90">
                  El Mago Xavi está analizando tu carta
                </p>
                <p className="text-xs text-white/45">Conectando con la energía del día</p>
              </div>
          ...
          (() => {
            ...
            return (
              <motion.div
                ...
                className="min-h-[calc(100dvh-3.5rem)] flex flex-col lg:flex-row min-h-0 overflow-x-hidden"
              >
