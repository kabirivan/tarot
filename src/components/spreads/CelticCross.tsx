            ...
            >
              ...
              <div className="space-y-2">
                <p className="font-display text-lg sm:text-xl font-light italic text-white/90">
                  El Mago Xavi está analizando tu cruz
                </p>
                <p className="text-xs text-white/45">Conectando con las diez posiciones</p>
              </div>
            ...
            >
              {selectedCards.slice(0, totalNeeded).map((rc, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="holo-card w-full aspect-[2/3] max-w-[34vw] sm:max-w-[17vw] min-w-0"
        ...
        {phase === "revealed" && (
          ...
          >
            ...
            <motion.div
              ...
              className="flex-shrink-0 flex flex-col items-center justify-center p-3 sm:p-4 lg:p-8 lg:w-[58%] min-h-0 order-1 lg:order-1"
            >
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3 w-full max-w-[448px] sm:max-w-[560px] mx-auto">
                {selectedCards.map((rc, i) => (
                  <motion.button
                    key={rc.card.id}
                    type="button"
