      ...
      <AnimatePresence mode="wait">
        ...
        {phase === "picking" && (
          ...
          >
            <motion.h2
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="text-base sm:text-lg font-medium text-white/80 mb-3 flex-shrink-0 text-center"
            >
          ...
          >
            ...
            >
              <span className="text-[10px] tracking-wide uppercase">
                Ver interpretación de tu pregunta
              </span>
        ...
        {phase === "revealed" && selectedCards.length > 0 && (() => {
          ...
          return (
            ...
            >
              {/* LEFT: Card (clickable) */}
              <div className="flex-shrink-0 flex flex-col items-center justify-center gap-2 p-3 sm:p-4 lg:p-8 lg:w-[55%]">
                <motion.span
